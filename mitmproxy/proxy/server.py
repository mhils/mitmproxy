...
class ConnectionIO:
    ...
    reader: Optional[Union[asyncio.StreamReader, udp.DatagramReader, mitmproxy_rs.TcpStream]] = None
    writer: Optional[Union[asyncio.StreamWriter, udp.DatagramWriter, mitmproxy_rs.TcpStream]] = None
